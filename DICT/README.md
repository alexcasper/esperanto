...
| O'Connor & Hayes, English-Esperanto Dictionary (c.1906) | `oconnor-1906` | 4147 |
| Corpus-mined, reviewed by hand | `corpus-mined` | 5126 |
| Correlative grid, generated by rule | `correlative-grid` | 6 |
...
181 entries carry a `grammar` field pointing at the section of
