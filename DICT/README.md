...
**27404 entries.** Every count in this section was measured against
...
| Corpus-mined, reviewed by hand | `corpus-mined` | 5174 |
...
By part of speech: noun 18114 · verb 4152 · adj 4113 · adv 855 · suffix 31 ·
prep 31 · num 29 · pron 26 · interj 16 · particle 12 · ending 9 · prefix 8 ·
conj 7 · art 1.

4113 entries carry `derived: true`, marking a word built by regular affixation
...
*samideano*) and productive derivations. All 5174 carry `attestation` (a
corpus `count` and the number of independent `sources`) and up to three real
`citations`; 3671 are attested in three or more independent sources.
...
12403 of them, including the cases where two reviewers disagreed.
